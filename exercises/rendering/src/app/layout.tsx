...
export const metadata: Metadata = {
  title: "TK Maxx Insider",
  description:
    "Your go-to hub for all things style tips, gifting guides, campaign lowdowns and much, much more from TK Maxx",
            ...
            <div className="container mx-auto flex h-16 max-w-screen-2xl items-center px-4 sm:px-6 lg:px-8">
              <div className="mr-4 flex">
                <Link className="mr-6 flex items-center space-x-2" href="/">
                  <p className="text-2xl font-bold">TK Maxx Insider</p>
                </Link>
